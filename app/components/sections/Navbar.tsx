...
const navLinks = [
  ...
  { label: "Tentang Kami", to: "/", hash: "why-choose-us" },
  { label: "Menu", to: "/", hash: "weekly-menu" },
  { label: "Paket & Harga", to: "/", hash: "pricing" },
  { label: "Cara Pemesanan", to: "/order" },
  { label: "Testimoni", to: "/", hash: "testimonials" },
  { label: "Kontak", to: "/", hash: "footer" },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="hidden lg:block">
            <a
              href="https://wa.me/6283117071327"
              target="_blank"
          ...
          <div className="max-w-7xl mx-auto px-4 py-4 space-y-3">
            {navLinks.map((link) => (
              <button
                ...
                className="block text-sm font-medium text-neutral-600 hover:text-primary-600 transition-colors py-2 w-full text-left"
              >
                {link.label}
              </button>
            ))}
